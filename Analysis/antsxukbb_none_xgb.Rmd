...
```{r xgb-none, message = FALSE, results = 'asis', echo = FALSE, fig.show = "hold", fig.align = "center", out.width='49%', eval = TRUE}
...
for( i in seq.int( ncol( targetMeasures ) ) )
  ...
  antsxukbbXgboost( brainData, response = targetName, type = targetMeasuresType[i],
    ...
    plotFilename = paste0( "Figures/none_xgb_", targetName ),
