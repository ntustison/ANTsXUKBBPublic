...
```{r glmnet-none, message = FALSE, results = 'asis', echo = FALSE, fig.show = "hold", fig.align = "center", out.width='49%', eval = TRUE}
...
for( i in seq.int( ncol( targetMeasures ) ) )
  ...
  antsxukbbLinearModel( brainData, response = targetName, type = targetMeasuresType[i],
    ...
    plotFilename = paste0( "Figures/none_glmnet_", targetName ),
    plotWidth = 3, plotHeight = 3, doPenalizedRegression = TRUE,
    glmnetAlpha = 0 )

  cat( "![", targetName, "]", "(", normalizePath( paste0( figuresDirectory, "none_glmnet_", targetName, ".pdf" ) ), ")", sep = "" )
  if( targetMeasuresType[i] == "regression" )
    {
    cat( "![", targetName, "]", "(", normalizePath( paste0( figuresDirectory, "none_glmnet_", targetName, "RegressionRegion.pdf" ) ), ")", sep = "" )
    knitr::include_graphics( c( paste0( figuresDirectory, "none_glmnet_", targetName, ".pdf" ),
                                paste0( figuresDirectory, "none_glmnet_", targetName, "RegressionRegion.pdf" ) ) )
    }
