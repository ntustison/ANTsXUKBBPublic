...
```{r xgb-mrmr, message = FALSE, out.height="100%", results = 'asis', eval = TRUE}
...
for( i in seq.int( ncol( targetMeasures ) ) )
  ...
  rmseFilename <- paste0( dataDirectory, "GradWarpExperiments/ukbiobank_mrmr_xgboost_", targetName, "_prediction.csv" )
  ...
  antsxukbbXgboost( brainData, response = targetName, pipelineNames = modelNames,
    ...
    plotFilename = paste0( "Figures/mrmr_xgb_", targetName ),
    plotWidth = 3, plotHeight = 3 )
  knitr::include_graphics( paste0( "Figures/mrmr_xgb_", targetName, ".pdf" ) )
  }
