...
```{r rf-pca, message = FALSE, results = 'asis', echo = FALSE, eval = TRUE}
...
for( i in seq.int( ncol( targetMeasures ) ) )
  ...
  rmseFilename <- paste0( dataDirectory, "GradWarpExperiments/ukbiobank_pca_random_forest_", targetName, "_prediction.csv" )
  ...
  antsxukbbRandomForest( brainData, modelFormula, pipelineNames = modelNames,
    ...
    plotFilename = paste0( "Figures/pca_rf_", targetName ),
    plotWidth = 3, plotHeight = 3 )
  knitr::include_graphics( paste0( "Figures/pca_rf_", targetName, ".pdf" ) )
  }
