...
```{r rf-mrmr, message = FALSE, out.height="100%", results = 'asis', eval = TRUE}
...
for( i in seq.int( ncol( targetMeasures ) ) )
  ...
  rmseFilename <- paste0( dataDirectory, "GradWarpExperiments/ukbiobank_mrmr_random_forest_", targetName, "_prediction.csv" )
  ...
  antsxukbbRandomForest( brainData, modelFormula, pipelineNames = modelNames,
    ...
    plotFilename = paste0( "Figures/mrmr_rf_", targetName ),
    plotWidth = 3, plotHeight = 3 )
  knitr::include_graphics( paste0( "Figures/mrmr_rf_", targetName, ".pdf" ) )
  }
